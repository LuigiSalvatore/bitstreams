...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/ip/ila_elapsed/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_elapsed xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_elapsed -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/Downloads/t1/proto/project_1/project_1.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_elapsed_sc.so .tmp_log xcelium_lib waves.shm c.obj)
