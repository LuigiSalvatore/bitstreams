...
#
# Script generated by Vivado on Fri Apr 12 00:01:27 -03 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_elapsed.sh
...
#
# Usage        : ila_elapsed.sh
#                ila_elapsed.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_elapsed.sh [-reset_run]
#                ila_elapsed.sh [-reset_log]
#                ila_elapsed.sh [-help]
#
...
#                script (type 'ila_elapsed.sh -help' for more information).
#
...
# script info
echo -e "ila_elapsed.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_elapsed.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/ip/ila_elapsed/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_elapsed xil_defaultlib.glbl -o ila_elapsed_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_elapsed_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/Downloads/t1/proto/project_1/project_1.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ila_elapsed_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_elapsed_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_elapsed.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_elapsed.sh [-help]\n\
Usage: ila_elapsed.sh [-step]\n\
Usage: ila_elapsed.sh [-lib_map_path]\n\
Usage: ila_elapsed.sh [-reset_run]\n\
Usage: ila_elapsed.sh [-reset_log]\n\
Usage: ila_elapsed.sh [-keep_index]\n\
Usage: ila_elapsed.sh [-noclean_files]\n\n\
